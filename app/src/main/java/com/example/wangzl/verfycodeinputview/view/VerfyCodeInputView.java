package com.example.wangzl.verfycodeinputview.view;
...
import com.example.wangzl.verfycodeinputview.R;
...
public class VerfyCodeInputView extends EditText {
    ...
    public VerfyCodeInputView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void getAtt(AttributeSet attrs) {
        borderColor = getResources().getColor(R.color.pay_pwd_divider_line);
        divideLineColor = getResources().getColor(R.color.pay_pwd_divider_line);
        focusedColor = getResources().getColor(R.color.bg_corner_bule);
...
//       super.onDraw(canvas);
    ...
    private void drawItemFocused(Canvas canvas, int position) {
        ...
        canvas.drawLine(position * divideLineWStartX, height, (position + 1) * divideLineWStartX, height,
                getPaint(8, Paint.Style.STROKE, focusedColor));
    }
    ...
    private void drawSelectText(Canvas canvas) {
        ...
        for (int i = 0; i < textLength; i++) {
            cX = startX + i * 2 * startX - 15;
            canvas.drawText(String.valueOf(inputText.charAt(i)), cX, startY, textPaint);
        }
    }
